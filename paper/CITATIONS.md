...
- Gu 2310.02664; Kadkhodaie 2310.02557; Somepalli 2212.03860; Carlini
  2301.13188 (memorization ↑ training, ↓ data).
...
- Li 2305.15583 (time-shift recoupling); Ning 2308.15321 (epsilon scaling);
  ...
  sampling impropriety); Ho 2106.15282 (conditioning augmentation ancestor).
...
## §6 (frontiers)
- Remy 2201.05561 + successors — posterior-sampling lineage (the H-arch
  fallback route; descent-not-competition framing per the solution-space
  note addendum 2).
- Schanz again where conditional-ensemble validation is credited.
