...
steps = [
    ...
    (0.1, "ATTEMPT 4a — augmentation = the diagnosis test", "8x D4 data: the collapse is GONE (curve flat at the real level for 20k steps;\nthe sigma-channel stays at ~90%) -> the mean-memorization diagnosis holds. Caveat: the literal\nonset rule mis-fired on a pre-peak warm-up dip (both readings reported; reconvene adjudicates).\nRemaining gap moved: the RECURSION compounds flattening octave-to-octave (end-to-end oct2\nstill ~7 sigma). Stopped at the readout. Figures: signature_4a.png, g1c_verdict.png.", BLUE, "readout->stop"),
]
