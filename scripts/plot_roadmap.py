...
steps = [
    ...
    (0.1, "GENERATOR FROZEN — the compounding limit is informational (measured)", "4a: collapse eliminated (memorization law causally confirmed). 4b': heads calibrated\n(~at real given real coarse). Attempt 5 (self-conditioning, FINAL): honesty about drifted\nconditioning is LOWER than over-trust -- end-to-end = drifted-input response (0.742=0.746),\nhonest limit ~0.5 -> B5, generator frozen per pre-commitment. Banked: P5 break, collapse law,\ncalibrated heads, drift measurements, validation architecture. Phase reshapes around these.\nFigures: readout_a5.png, readout_4bp.png, signature_4a.png.", "#0072B2", "FROZEN"),
]
